      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-gradient-to-br from-akf-primary to-akf-primary-dark rounded-3xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-40 h-40 bg-white/10 rounded-full blur-2xl" />
              <MapPin className="w-12 h-12 sm:w-16 sm:h-16 text-white mb-6" />
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">Where We Serve</h3>
              ...
              <ul className="space-y-3">
                {workAreas.map((area, index) => (
                  <motion.li
                    ...
                    className="flex items-center gap-3 bg-white/15 rounded-lg px-4 py-3 text-white font-medium transition-all duration-300 hover:bg-white/25 hover:translate-x-1"
                  >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Community at the Centre</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 bg-akf-steampunk-light rounded-xl p-5 border border-akf-steampunk mt-6 transition-all duration-300 hover:border-akf-primary hover:shadow-md">
