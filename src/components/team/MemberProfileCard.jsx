...
export default function MemberProfileCard({ member, index, onSelect }) {
  ...
  return (
    ...
    >
      <Card
        className="overflow-hidden p-0 flex flex-col cursor-pointer select-none"
        role="button"
        tabIndex={0}
      ...
      >
        ...
        <div className="p-6 flex flex-col">
          ...
          <span className="pt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-akf-primary-dark">
            View profile
